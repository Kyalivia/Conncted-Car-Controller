...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|D7_1602_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, D6_1602_Pin|FAN1_Pin|FAN2_Pin|FAN3_Pin
                          |D5_1602_Pin|D4_1602_Pin|EN_1602_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : RS_1602_Pin */
  GPIO_InitStruct.Pin = RS_1602_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(RS_1602_GPIO_Port, &GPIO_InitStruct);
